...
function Breadcrumb() {
  ...
  return (
    <nav className="breadcrumb anim-breadcrumb" style={{ marginBottom: "20px", display: "flex", alignItems: "center", flexWrap: "wrap" }}>
      ...
      <span style={{ color: "#555", fontWeight: 400 }}>Problems with ULIPs in India</span>
    </nav>
  );
}
      ...
      <div className="ulip-page" style={{ fontFamily: "'Inter', sans-serif", background: "#f5f3ee", minHeight: "100vh" }}>
        <style>{`
          ...
          @media (max-width: 768px) {
            ...
            /* Insight card: tighten padding */
            .anim-insight { padding: 18px 20px !important; }

            /* Quote block: left-align and tighten */
            ...
            /* Section top padding */
            .ulip-page > div:first-child { padding-top: 24px !important; }
          }
          ...
          <div className="hero-wrapper">
            ...
            >
              ...
              <img
                ...
                alt="Problems with ULIPs in India"
                style={{
                  position: "absolute",
                  top: "50%",
                  left: "50%",
