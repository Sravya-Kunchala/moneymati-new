  ...
  return (
    ...
    >
      <style>{`
        ...
        .cagr-select-wrap {
          display:flex; align-items:center; background:#f0ede8;
          border-radius:12px; padding:14px 16px; gap:8px; position:relative;
        }
        .cagr-select-wrap select {
          border:none; outline:none; background:transparent;
          font-size:15px; font-weight:500; color:#222; width:100%;
        ...
        <div style={{ maxWidth: "680px", margin: "-80px auto 0", position: "relative", zIndex: 10 }}>
          ...
          >
            ...
            <p style={{ fontSize: 14, color: "#666", lineHeight: 1.7, maxWidth: 440, margin: "0 auto" }}>
              Compound Annual Growth Rate (CAGR) helps you understand the average annual return on your investments over a period of time. Evaluate performance and make smarter financial decisions.
            </p>
          </div>
        </div>
      </div>
              ...
              <div style={{ marginTop: 24, padding: "20px", background: "#f0faf4", borderRadius: 12, border: "1px solid #c3e6d0" }}>
                <div className="result-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, textAlign: "center" }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 16, fontWeight: 800, color: "#11D462" }}>{fmt(ulipCAGR)}%</div>
                  </div>
                </div>
              </div>
            )}
            ...
            {[
              {
                cls: "anim-why-card-0",
                title: "What is CAGR?",
                desc: "CAGR (Compound Annual Growth Rate) shows the average yearly growth of your investment over a period of time, assuming returns are compounded.",
                icon: (
              ...
              },
              {
                ...
                desc: "It helps you evaluate how well your investments have performed and compare different investment options effectively.",
                icon: (
              ...
              },
              {
                cls: "anim-why-card-2",
                title: "The Benefits",
                desc: "CAGR simplifies complex returns into a single percentage, making it easier to understand growth and make better financial decisions.",
                icon: (
