  ...
  return (
    <div className={inter.className} style={{ backgroundColor: "#f5f0e8", minHeight: "100vh", fontFamily: "var(--font-inter), sans-serif" }}>
      <style>{`
        ...
        .sip-field label span.req { color: #333; }
        .sip-input-wrap {
          display: flex;
          align-items: center;
          background: #f0ede8;
        ...
        .sip-input-wrap .prefix {
          font-size: 15px;
          color: #555;
          font-weight: 500;
        }
        .sip-input-wrap .suffix {
          font-size: 14px;
          color: #888;
          font-weight: 500;
          margin-left: auto;
        ...
        @media (max-width: 767px) {
          ...
          /* Overlap card — switch from absolute to static flow */
          .hero-overlap-outer {
          ...
          /* Spacer — shrink since card is in flow */
      ...
      <div className="main-content" style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 48px 48px", backgroundColor: "#f5f0e8", position: "relative", zIndex: 1 }}>
        ...
        <div className="anim-calculator" style={{ marginBottom: 32, position: "relative", zIndex: 1 }}>
          <div className="calc-card" style={{ background: "#ffffff", borderRadius: 20, padding: "36px 40px", boxShadow: "0 2px 16px rgba(0,0,0,0.07)", maxWidth: 680, margin: "0 auto" }}>
            ...
            {/* Field 1: Goal or Target */}
            <div className="sip-field">
              <label>Your Goal or Target (to be reached) <span className="req">*</span></label>
              <div className="sip-input-wrap">
                <span className="prefix">₹</span>
                <input
                  type="number"
                  value={targetAmount}
                  onChange={(e) => { setTargetAmount(e.target.value); setSubmitted(false); }}
                  placeholder="50,000"
                />
              </div>
            </div>

            {/* Field 2: Years to reach goal */}
            <div className="sip-field">
              <label>Years to reach goal <span className="req">*</span></label>
              <div className="sip-input-wrap">
                <input
                  type="number"
                  value={years}
            ...
            <div className="sip-field">
              ...
              <div className="sip-input-wrap">
                <input
                  ...
                  step={0.1}
                  value={roi}
                  onChange={(e) => { setRoi(e.target.value); setSubmitted(false); }}
                  placeholder="15.1"
                />
              ...
              <div style={{ marginTop: 24, padding: "20px", background: "#f0faf4", borderRadius: 12, border: "1px solid #c3e6d0" }}>
                <div className="grid-3col-result">
                  <div>
                    ...
                    <div style={{ fontSize: 18, fontWeight: 800, color: "#0d3d20" }}>₹{monthlySIP.toLocaleString("en-IN")}</div>
                  </div>
                  <div>
                    <div style={{ fontSize: 12, color: "#666", marginBottom: 4 }}>Total Invested</div>
                    <div style={{ fontSize: 18, fontWeight: 800, color: "#0d3d20" }}>₹{totalInvested.toLocaleString("en-IN")}</div>
                  </div>
                  <div>
                    <div style={{ fontSize: 12, color: "#666", marginBottom: 4 }}>Returns Earned</div>
                    <div style={{ fontSize: 18, fontWeight: 800, color: "#11D462" }}>₹{totalReturns.toLocaleString("en-IN")}</div>
                  </div>
                </div>
              </div>
            )}
