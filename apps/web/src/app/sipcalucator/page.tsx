  ...
  return (
    <div className={inter.className} style={{ backgroundColor: "#f5f0e8", minHeight: "100vh", fontFamily: "var(--font-inter), sans-serif" }}>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 48px 48px", backgroundColor: "#f5f0e8", position: "relative", zIndex: 1 }}>
        ...
        {/* Calculator — Form style matching Image 1 */}
        <div className="anim-calculator" style={{ marginBottom: 32, position: "relative", zIndex: 1 }}>
          <div style={{ background: "#ffffff", borderRadius: 20, padding: "36px 40px", boxShadow: "0 2px 16px rgba(0,0,0,0.07)", maxWidth: 680, margin: "0 auto" }}>
            ...
            <div className="sip-field">
              ...
              <div className="sip-input-wrap">
                ...
                <input
                  type="number"
                  value={targetAmount}
                  onChange={(e) => { setTargetAmount(Number(e.target.value)); setSubmitted(false); }}
                  placeholder="50,000"
                />
              </div>
            </div>
            ...
            <div className="sip-field">
              ...
              <div className="sip-input-wrap">
                <input
                  type="number"
                  value={years}
                  onChange={(e) => { setYears(Number(e.target.value)); setSubmitted(false); }}
                  placeholder="10"
                />
            ...
            <div className="sip-field">
              ...
              <div className="sip-input-wrap">
                <input
                  ...
                  step={0.1}
                  value={roi}
                  onChange={(e) => { setRoi(Number(e.target.value)); setSubmitted(false); }}
                  placeholder="15.1"
                />
