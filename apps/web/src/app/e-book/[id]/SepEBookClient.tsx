// src/app/e-book/[id]/SepEBookClient.tsx
"use client";
          ...
          {others.map((book) => (
            ...
            >
              <div style={{ position: "relative", height: "180px", background: "#0A2E24", overflow: "hidden" }}>
                ...
                <span style={{ position: "absolute", bottom: "10px", left: "12px", padding: "3px 10px", borderRadius: "4px", background: "#0A5C45", color: "#fff", fontSize: "10px", fontWeight: 700, letterSpacing: "0.8px", textTransform: "uppercase" }}>
                  {book.category}
                </span>
              </div>
