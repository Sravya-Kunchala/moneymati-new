...
export default function GoalCalculatorPage() {
  ...
  const futureGoal = Math.round(presentValue * Math.pow(1 + inflation / 100, years));
  ...
  return (
    <div className={inter.className} style={{ backgroundColor: "#f5f0e8", minHeight: "100vh", fontFamily: "var(--font-inter), sans-serif" }}>
      ...
      {/* Hero */}
      <div className="anim-hero" style={{ position: "relative", minHeight: "320px", padding: "80px 48px 120px", backgroundColor: "#0d2818" }}>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 48px 48px", backgroundColor: "#f5f0e8", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ background: "#ffffff", borderRadius: 20, padding: "36px 40px", boxShadow: "0 2px 16px rgba(0,0,0,0.07)", maxWidth: 720, margin: "0 auto" }}>
            ...
            <div className="goal-field" style={{ marginBottom: 20 }}>
              ...
              <div className="goal-input-wrap">
                ...
                <input type="number" value={presentValue} onChange={(e) => { setPresentValue(Number(e.target.value)); setSubmitted(false); }} placeholder="50,000" />
              </div>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 20 }}>
              <div className="goal-field">
                ...
                <div className="goal-input-wrap">
                  <input type="number" value={years} onChange={(e) => { setYears(Number(e.target.value)); setSubmitted(false); }} placeholder="10" />
              ...
              <div className="goal-field">
                ...
                <div className="goal-input-wrap">
                  <span className="pfx">₹</span>
                  <input type="number" value={alreadyHave} onChange={(e) => { setAlreadyHave(Number(e.target.value)); setSubmitted(false); }} placeholder="5,000" />
                </div>
              </div>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 24 }}>
              <div className="goal-field">
                ...
                <div className="goal-input-wrap">
                  <input type="number" step={0.1} value={inflation} onChange={(e) => { setInflation(Number(e.target.value)); setSubmitted(false); }} placeholder="12" />
              ...
              <div className="goal-field">
                ...
                <div className="goal-input-wrap">
                  <input type="number" step={0.1} value={expectedReturns} onChange={(e) => { setExpectedReturns(Number(e.target.value)); setSubmitted(false); }} placeholder="15.1" />
                  <span className="sfx">%</span>
                </div>
              </div>
            </div>
            ...
            {submitted && (
              <div style={{ marginTop: 24, padding: "20px", background: "#f0faf4", borderRadius: 12, border: "1px solid #c3e6d0" }}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 16, textAlign: "center" }}>
                  <div>
                    <div style={{ fontSize: 12, color: "#666", marginBottom: 4 }}>Inflation-Adjusted Goal</div>
                    <div style={{ fontSize: 16, fontWeight: 800, color: "#0d3d20" }}>₹{futureGoal.toLocaleString("en-IN")}</div>
                  </div>
                  <div>
                    <div style={{ fontSize: 12, color: "#666", marginBottom: 4 }}>Corpus Still Needed</div>
                    <div style={{ fontSize: 16, fontWeight: 800, color: "#0d3d20" }}>₹{remainingCorpus.toLocaleString("en-IN")}</div>
                  </div>
                  <div>
                    <div style={{ fontSize: 12, color: "#666", marginBottom: 4 }}>Monthly SIP Required</div>
                    <div style={{ fontSize: 16, fontWeight: 800, color: "#11D462" }}>₹{monthlySIP.toLocaleString("en-IN")}</div>
                  </div>
                </div>
              </div>
            )}
            ...
            {[
              {
                ...
                // Same SVG as SIP card 0 (gear/brain icon)
                icon: (
              ...
              },
              {
                ...
                // Same SVG as SIP card 1 (shield-heart icon)
                icon: (
              ...
              },
              {
                ...
                // Same SVG as SIP card 2 (sparkle-trend icon)
                icon: (
        ...
        <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }}>
            {[
              {
                // Same as SIP page "Goal Calculator" card SVG
                ...
                title: "SIP Calculator", desc: "Exact monthly contribution needed.", cls: "anim-calc-card-0",
              },
              {
                // Same as SIP page "Retirement Calculator" card SVG
                ...
                title: "Retirement Calculator", desc: "Build your post-work nest egg.", cls: "anim-calc-card-1",
              },
              {
                // Same as SIP page "Sukanya Samriddhi" card SVG
                ...
                title: "Sukanya Samriddhi", desc: "Secure your daughter's future.", cls: "anim-calc-card-2",
              },
              {
                // Same as SIP page "CAGR Calculator" card SVG
                ...
                title: "CAGR Calculator", desc: "Find annual compound returns.", cls: "anim-calc-card-3",
              },
            ].map((item) => (
