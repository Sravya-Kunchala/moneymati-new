    ...
    <div className={inter.className} style={{ backgroundColor: "#f5f0e8", minHeight: "100vh", fontFamily: "var(--font-inter), sans-serif" }}>
      <style>{`
        ...
        @media (max-width: 767px) {
          ...
          /* Stack the 2-col grids to 1 col */
          .gc-grid-2 {
          ...
          .gc-results-grid > div:last-child {
            border-bottom: none;
            padding-bottom: 0;
          }
        ...
        <div>
          ...
          <div className="gc-calc-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }}>
            {[
              ...
              <div key={item.title} className={`${item.cls} gc-calc-card`} style={{ background: "#ffffff", borderRadius: 14, padding: "20px", boxShadow: "0 2px 8px rgba(0,0,0,0.05)", cursor: "pointer" }}>
