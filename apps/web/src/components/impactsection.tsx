...
export default function ImpactSection() {
  return (
    <section className="relative w-full bg-[#1a3a2a] py-24 px-8 flex flex-col items-center overflow-hidden">

      {/* Wave 1 — darkest */}
      <div className="absolute bottom-0 left-0 w-full pointer-events-none" style={{ zIndex: 1 }}>
        <svg width="100%" height="216" viewBox="0 0 1439 216" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
      ...
      <div className="absolute bottom-0 left-0 w-full pointer-events-none" style={{ zIndex: 2 }}>
        <svg width="100%" height="287" viewBox="0 0 1439 287" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
      ...
      {/* Wave 3 — right side lighter */}
      <div className="absolute top-0 right-0 w-1/3 h-full pointer-events-none" style={{ zIndex: 0 }}>
        <svg width="100%" height="100%" viewBox="0 0 480 400" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
          <path d="M480 0C380 50 200 100 0 400H480V0Z" fill="#2d5a3d" fillOpacity="0.5"/>
        </svg>
      </div>
      ...
      {/* Stats */}
      <div className="grid grid-cols-4 gap-4 max-w-4xl w-full relative z-10">
        {stats.map(({ value, label }) => (
          <div
            key={label}
            className="bg-[#ECFDF5] rounded-xl px-4 py-5 flex flex-col gap-2 justify-center items-center text-center"
          >
