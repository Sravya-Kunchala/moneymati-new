...
const ArticleCard: React.FC<{ article: Article }> = ({ article }) => (
  <div
    style={{ backgroundColor: "#ffffff", borderRadius: "12px", overflow: "hidden", display: "flex", flexDirection: "column", boxShadow: "0 1px 4px rgba(0,0,0,0.06)", transition: "box-shadow 0.2s ease, transform 0.2s ease", cursor: "pointer" }}
...
const WeeklyDigest: React.FC = () => {
  ...
  return (
    <div style={{ backgroundColor: "#f0f7f4", borderRadius: "16px", padding: "24px", display: "flex", flexDirection: "column", gap: "14px" }}>
      ...
      <input type="email" placeholder="Your email address" value={email} onChange={(e) => setEmail(e.target.value)} style={{ width: "100%", padding: "12px 16px", borderRadius: "8px", border: "1px solid #e2e8f0", backgroundColor: "#ffffff", fontSize: "14px", color: "#1a1a1a", outline: "none", boxSizing: "border-box", fontFamily: "var(--font-dm-sans), sans-serif" }} />
...
const ExpertContributors: React.FC = () => (
  <div style={{ backgroundColor: "#ffffff", borderRadius: "16px", padding: "20px 24px", display: "flex", flexDirection: "column", gap: "16px" }}>
...
export default function LatestArticles() {
  ...
  return (
    ...
    >
      {/* Decorative SVGs — side by side like // */}
      <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", zIndex: 0, opacity: 0.6, pointerEvents: "none", display: "flex" }}>
        ...
        <svg width="965" height="306" viewBox="0 0 965 306" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginLeft: "-700px" }}>
          <path d="M0 305.5C15.4354 299.924 31.8263 293.98 47.2054 288.444C190.536 236.862 333.766 186.541 477.968 138.103C622.177 90.5243 766.394 40.9642 914.866 7.55337C930.335 4.39589 948.679 1.0486 964.5 0C948.674 0.982021 930.312 4.26774 914.829 7.36718C766.199 40.2597 621.867 89.5736 477.65 137.155C333.437 185.597 190.289 236.175 47.1406 288.266C31.7818 293.858 15.4126 299.861 0 305.5Z" fill="#677E73"/>
        </svg>
      </div>
