    ...
    >
      ...
      {!isMobile && (
        ...
        >
          ...
          >
            Secure your financial future with a personalized premium
            consultation.
          </p>
          <div
            style={{
      ...
      <div
        style={{
          flex: 1,
          padding: isMobile ? "28px 20px 32px" : 36,
          position: "relative",
          background: "#fff",
          overflowY: "auto",
      ...
      >
        ...
        {isMobile && (
          ...
          >
            ...
            />
            <span
              style={{ fontWeight: 900, fontSize: 15, color: "#0b2f24", letterSpacing: 0.4 }}
            >
              MONEYMATI
            </span>
          </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: "grid", gap: 12 }}>
            ...
            <div style={{ position: "relative" }}>
              <span style={iconWrapStyle}>
                <svg width="16" height="12" viewBox="0 0 16 12" fill="none">
                  ...
                  />
                  <path
                    d="M1 2.5V10.5C1 11.0523 1.44772 11.5 2 11.5H14C14.5523 11.5 15 11.0523 15 10.5V2.5"
                    stroke="#475569"
                    strokeWidth="0.8"
                    strokeLinecap="round"
                    strokeLinejoin="round"
          ...
          <div>
            ...
            <div style={{ position: "relative" }}>
              <span style={iconWrapStyle}>
                <svg width="16" height="18" viewBox="0 0 16 18" fill="none">
                  <path
                    d="M2 3h12M4 1v4M12 1v4M2 3v12h12V3z"
                    stroke="#475569"
                    strokeWidth="0.9"
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            {errors.datetime && (
              <p style={errorStyle}>{errors.datetime}</p>
            )}
          </div>
      ...
      >
        ...
        >
          <svg width={22} height={22} viewBox="0 0 24 24" fill="none">
            <path
              d="M8 7V3M16 7V3M3 11h18M5 21h14a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2z"
              stroke="#0b3a2f"
              strokeWidth="1.4"
              strokeLinecap="round"
              strokeLinejoin="round"
  ...
  const modal = (
    ...
    >
      {isMobile && !showSuccess ? (
        // Centered card on mobile with full border radius
        <div
          style={{
            width: "92%",
            maxWidth: 420,
        ...
        // Success modal centered on mobile
        <div
          style={{
            width: "92%",
            maxWidth: 420,
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center w-full">
        <h2 className="text-4xl font-bold text-white leading-snug mb-6">
          ...
          Starts{" "}
          <em style={{ color: "#FFB600" }} className="italic">
            Today
          </em>
        </h2>
        ...
        >
          ...
          level up your wealth-building strategy, MoneyMati has the tools and
          community to help you succeed.
        </p>

        {/* FIXED: no more hardcoded 150px padding */}
        <button
