...
export default function TrustSection() {
  return (
    <>
      ...
      <section
        className={`ts-section ${playfairDisplay.variable} ${dmSans.variable}`}
        style={{
          position: "relative",
          overflow: "hidden",
      ...
      >
        ...
        >
          ...
          {/* Feature cards grid */}
          <div
            className="ts-grid grid grid-cols-1 sm:grid-cols-2 gap-4 w-full"
        ...
        >
          ...
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            style={{ position: "absolute", bottom: 0, left: 0, zIndex: 2, display: "block" }}
          >
