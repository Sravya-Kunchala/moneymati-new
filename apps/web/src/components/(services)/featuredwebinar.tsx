...
export default function FeaturedWebinar() {
  return (
    <>
      ...
      <section className={`fw-section-wrap w-full bg-[#f5f0e8] py-12 px-8 relative overflow-hidden`}>

        {/* Top diagonal line */}
        <svg className="fw-svg-top" width="965" height="306" viewBox="0 0 965 306" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        <svg className="fw-svg-bottom" width="965" height="306" viewBox="0 0 965 306" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          {/* Header */}
          <div className="fw-header flex items-start justify-between mb-6">
            <div>
              <h2
                className={`${playfair.variable} fw-heading`}
                style={{ fontWeight: 700, fontSize: "30px", lineHeight: "36px", letterSpacing: "0px", color: "#004D40" }}
              >
                Featured Webinar
              </h2>
              <p
                className={`${inter.className} fw-subheading mt-1`}
            ...
            <div className="fw-desktop-nav flex items-center gap-2">
          ...
          {/* Card */}
          <div className="fw-card bg-white rounded-2xl overflow-hidden flex shadow-sm min-h-[400px]">

            {/* Left — Image */}
            <div className="fw-card-image relative w-[500px] flex-shrink-0">
              <Image src="/webinar-featured.svg" alt="Featured Webinar" fill className="object-cover" />
            </div>

            {/* Right — Content */}
            <div className="fw-card-content flex flex-col gap-4 justify-center" style={{ padding: "40px 32px 40px 40px" }}>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={`${inter.className} text-[#10B981] text-xs font-semibold tracking-widest uppercase`}>
                  March 24, 2026 • 6:00 PM IST
                </span>
              </div>

              {/* Title */}
              <h3
                className={`${inter.className} fw-title`}
                style={{ fontWeight: 700, fontSize: "40px", lineHeight: "52px", letterSpacing: "0px", color: "#004D40", maxWidth: "420px" }}
              >
              ...
              {/* Description */}
              <p
                className={`${inter.className} fw-desc`}
                style={{ fontWeight: 400, fontSize: "18px", lineHeight: "29px", letterSpacing: "0px", color: "#475569", maxWidth: "420px" }}
              >
              ...
              <div className="flex items-center gap-4 mt-2">
                <button
                  ...
                  style={{ backgroundColor: "#FFB600", borderRadius: "9999px", padding: "10px 24px", fontSize: "14px", whiteSpace: "nowrap", border: "none", cursor: "pointer" }}
                >
                  Register Now
                </button>

                {/* Avatars */}
                <div className="fw-avatars flex items-center -space-x-2">
                  ...
                  <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                    ...
                    <defs>
                      ...
                      <image id="image0_25_603" width="80" height="80" preserveAspectRatio="none" xlinkHref="data:image/jpeg;base64,"/>
                    </defs>
                  </svg>
          ...
          <div className="fw-mobile-nav">
            <button className="fw-nav-btn-style">
              <ChevronLeft className="w-4 h-4 text-gray-500" />
            </button>
            <button className="fw-nav-btn-style">
              <ChevronRight className="w-4 h-4 text-gray-500" />
